...
class ContactsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let summi = Contact(name: "Summi", phoneNumber: "07446426767")
        let jenny = Contact(phoneNumber: "07123456789")
        let aldo = Contact(name: "Aldo")
        
        self.contacts.append(summi)
        self.contacts.append(jenny)
        self.contacts.append(aldo)
